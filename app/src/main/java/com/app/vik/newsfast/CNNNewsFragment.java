...
public class CNNNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cnnnews, container, false);

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.cnn_rv);
    ...
    private void loadArticles(){
        ...
        Call<Result> call = apiInterface.getNewsArticles("cnn", "e2d41ec29c9344a786104f5b19ed31ef");
